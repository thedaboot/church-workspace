...
//
// **이 길은 임베딩·벡터 색인을 쓰지 않는다.** 개역한글 전문은 4.5MB이고 절이 31,103개다 —
...
// 화면에 세우는 최대 줄 수. 2026-09-21에 12 → 30으로 올렸다(사용자 요청 — "최대 11개만
// 나오는 듯한데 30개는 나오도록"). 이 값 하나가 **프롬프트의 상한과 파서의 자르는 자리**를
// 같이 정한다 — 둘을 따로 적으면 모델이 더 낸 것을 우리가 버리거나 그 반대가 된다.
export const AI_HIT_LIMIT = 30;
