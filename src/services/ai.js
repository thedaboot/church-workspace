...
export const AiService = {
  ...
  polishText: async (text, task = null) => {
    const prompt = [
      ...
      '',
      '### 청년별 담당 업무',
      '- @조해리 · 송폼 오타 다시 확인 · 8월 31일까지',
      '- @조준환 · 카운트다운 시작 시각 공지 · 8월 29일까지',
      '---예시 끝---',
      '',
      ...
      '  조해리 | 찬양팀·임원진 | 총무님 | 멘션은 @조해리',
      '  박지호 | 웰컴팀·미디어팀 | 리더팀장님 | 멘션은 @박지호',
      '  김승찬 | 찬양팀 | 직함 없음 | 멘션은 @김승찬',
      'before:',
      '10월 찬양예배 주제 전도에서 예배자로 바꿈 예배시간 15시30분에서 15시로 당김 각 팀장님들 26일까지 댓글로 진행상황 공유 찬양팀 콘티 이번주내 확정 웰컴팀은 오픈퀘스천 질문 컨펌하고 조편성 방법 정하기 미디어팀 예배전영상 제작현황이랑 업로드 마감일 엔지니어팀 송출계획 역할분담 ppt 완료일정 10월3일 연습가능한지 확인필요',
      'after:',
      '### 10월 찬양 예배 준비',
      '',
      '### 정한 것',
      '- 10월 주제를 전도에서 ==예배자==로 바꿔요',
      '- 예배 시작을 **15시 30분**에서 **15시**로 당겨요',
      '',
      '### 아직 정하지 못한 것',
      '- ==10월 3일 연습이 가능한지== 팀원·팀장 일정을 확인해야 해요',
      '',
      '### 청년별 담당 업무',
      // 찬양팀이 목록에 둘(조해리·김승찬) → 한 줄에 여럿
      '- @조해리 @김승찬 · 10월 콘티 확정 · 9월 26일까지',
      // 웰컴팀·미디어팀은 박지호 하나씩 → 각각 그 사람에게
      '- @박지호 · Open Question 질문 컨펌하고 조편성 방법 정하기 · 9월 26일까지',
      '- @박지호 · 예배 전 영상 제작 현황 공유하고 업로드 마감일 정하기 · 9월 26일까지',
      // 엔지니어팀은 목록에 아무도 없다 → 팀 이름으로
      '- @엔지니어팀 · 영상 송출 계획과 역할 분담 정하고 PPT 완료 일정 잡기 · 9월 26일까지',
      // 누구 몫인지 글에도 없고 팀도 안 갈린다 → 이름 없이 할 일만
      '- 10월 3일 전날 리허설이 가능한지 팀원과 팀장 일정 확인 · 9월 26일까지',
      '---예시 끝---',
      '',
      task ? '\n' + buildTaskContext(task) : '',
      '',
    ...
    const sysPrompt = [
      ...
      '- 원문이 사람을 짚었으면 그 사람(`@조해리`).',
      '- 팀만 짚었으면, 또는 일의 성격으로 팀이 분명하면, **그 목록에서 그 팀 사람을 찾아 붙여라.**',
      '  · 그 팀 사람이 여럿이면 **한 줄에 여럿** 적어라: `- @조해리 @박지호 · 조편성 방법 정하기 · 9월 26일까지`',
      ...
      '- 다만 "각 팀장님들은 26일까지"처럼 **여럿에 걸리는 기한**이 적혀 있으면 그 범위의 줄에 나눠 붙여라.',
      '- 달이 빠진 날짜("26일까지")는 오늘 기준으로 가장 가까운 앞날로 읽어라.',
      '',
