...
export const AiService = {
  ...
  polishText: async (text, task = null) => {
    ...
    const prompt = [
      ...
      // 기한이 아닌 날짜(연습 날짜)도 예시에 두지 않는다 — 다음 A/B에서 예시의 '4월 25일 연습'이
      // 기한 없는 수련회 피드백 카드에 '10월 25일까지'로 옮겨 왔다. 예시의 날짜는 '17일까지' 하나다.
    ...
    const sysPrompt = [
      ...
      '',
      '기한:',
      '- **원문에 적힌 기한만 붙여라.** 원문에 날짜가 하나도 없으면 이 도막의 어느 줄에도 날짜를 붙이지 마라 — 지어내지 마라.',
