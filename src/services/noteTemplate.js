...
// **'나의 묵상'을 빼고 '결단'을 '나의 결단'으로** 고쳤다(예배 노트 넷 · QT 셋).
// 요약과 묵상이 같은 글이 되는 자리를 없애고, 남는 도막마다 "내가 무엇을 하기로 했는지"가
// 이름에 들어간다. 이건 **기본값일 뿐이고** 편집기 안의 보통 글이라 쓰는 사람이 제목을
...
export const WORSHIP_SECTIONS = ['본문', '말씀 요약', '나의 결단', '기도'];
export const QT_SECTIONS = ['본문', '나의 결단', '기도'];
...
const LEGACY_SECTIONS = ['묵상 노트', '결단하기', '기도하기', '나의 묵상', '결단'];
