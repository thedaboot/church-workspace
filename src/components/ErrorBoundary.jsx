      ...
      return (
        <div className="p-6 bg-surface border border-line rounded-lg shadow-soft m-4 flex items-start gap-3">
          ...
          <div>
            ...
            <button onClick={() => this.setState({ hasError: false })} className="mt-3 px-3 py-1 bg-red-100 hover:bg-red-200 text-red-800 text-xs rounded-md font-medium transition active:scale-95">다시 시도</button>
          </div>
        </div>
      );
    }
