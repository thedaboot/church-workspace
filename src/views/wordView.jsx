...
//
// **편집도 그 종이 안에서 한다**(사용자 요청 2026-09-10 · PITFALLS §6-32-p) — 부품이
...
// lazy로 떼어 둔다(HANDOFF §2 '화면별 lazy') — 성경 읽기만 보다 나가는 사람은 받지 않는다.
...
// 편집 화면도 종이가 되면서 두 높이가 내용에 따라 달라졌다 — 남은 차이는 HANDOFF §2 '사용자 판단 대기'에 있다.
