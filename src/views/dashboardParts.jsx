...
// ── 사역의 무게 (사람별 남은 업무) ────────────────────────────────────────
// 팀별과 나란히 두는 사람별 집계. '부하'·'과부하'·'병목' 같은 판정어는 쓰지 않는다 —
// 사람 수가 적은 팀에서는 그런 말이 지적처럼 읽힌다. 이름 · 남은 건수 · 막대만 두고,
// 무게는 막대 길이로 읽히게 한다(가장 많이 맡은 사람 기준의 상대 길이).
// 담당자가 없는 업무는 여기 세지 않는다 — 그건 사람의 무게가 아니다.
